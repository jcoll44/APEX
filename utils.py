...
#original code: https://github.com/JindongJiang/SCALOR/blob/master/utils.py
...
def calc_kl_z_pres_bernoulli(z_pres_prob, prior_pres_prob, eps=1e-15):
    z_pres_probs = z_pres_prob.view(-1)
